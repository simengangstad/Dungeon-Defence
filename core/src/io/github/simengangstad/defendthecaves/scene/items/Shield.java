...
public class Shield extends Item {
    ...
    private TextureRegion currentRegion = animation.getKeyFrame(0.0f);
    ...
    public Shield() {
        ...
        super(new Vector2(), new Vector2(Game.EntitySize, Game.EntitySize), animation.getKeyFrames()[0], false);
    ...
    public void draw(SpriteBatch batch) {
        ...
        currentRegion = animation.getKeyFrame(blockTimer, true);
