...
public class CraftableItemsView extends SlotView implements InputProcessor {
    ...
    public static final Sound CraftSound = Gdx.audio.newSound(Gdx.files.internal("assets/sfx/craft.ogg")), ErrorSound = Gdx.audio.newSound(Gdx.files.internal("assets/sfx/error.wav"));
