...
public class  Potion extends Item {
    ...
    public static final Sound Breaking = Gdx.audio.newSound(Gdx.files.internal("sfx/breaking.wav")), Drinking = Gdx.audio.newSound(Gdx.files.internal("sfx/rpg/inventory/bottle.ogg")), Burp = Gdx.audio.newSound(Gdx.files.internal("sfx/burp.wav"));
