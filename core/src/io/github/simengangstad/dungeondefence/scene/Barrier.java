...
import io.github.simengangstad.dungeondefence.scene.gui.ProgressBarStyle;
...
public class Barrier {
    ...
    public Barrier(Vector2 position, Map map, Player player) {
        ...
        progressBar.setStyle(new ProgressBarStyle(Game.UISkin.getDrawable("speech-bubble"), Game.UISkin.getDrawable("progress2")));
