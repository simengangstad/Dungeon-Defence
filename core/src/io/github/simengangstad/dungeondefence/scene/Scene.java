...
import io.github.simengangstad.dungeondefence.*;
import io.github.simengangstad.dungeondefence.audio.Jukebox;
import io.github.simengangstad.dungeondefence.pathfinding.PathfindingGrid;
import io.github.simengangstad.dungeondefence.procedural.MapGenerator;
import io.github.simengangstad.dungeondefence.scene.entities.Enemy;
...
public class Scene extends Container {
    ...
    public Scene() {
        ...
        jukebox.addMusicToGroup(Normal, Gdx.audio.newMusic(Gdx.files.internal("music/Normal/Black Sapphire.mp3")));
        jukebox.addMusicToGroup(Normal, Gdx.audio.newMusic(Gdx.files.internal("music/Normal/Chimera.mp3")));
        jukebox.addMusicToGroup(Normal, Gdx.audio.newMusic(Gdx.files.internal("music/Normal/After The Fall.mp3")));

        jukebox.addMusicToGroup(Calm, Gdx.audio.newMusic(Gdx.files.internal("music/Calm/Wood Elves.mp3")));
        jukebox.addMusicToGroup(Calm, Gdx.audio.newMusic(Gdx.files.internal("music/Calm/Homecoming.mp3")));

        jukebox.addMusicToGroup(High, Gdx.audio.newMusic(Gdx.files.internal("music/High/Battle Lines.mp3")));
        jukebox.addMusicToGroup(High, Gdx.audio.newMusic(Gdx.files.internal("music/High/In Pursuit.mp3")));

        jukebox.addMusicToGroup(Scary, Gdx.audio.newMusic(Gdx.files.internal("music/Scary/Creepy Hollow.mp3")));
        jukebox.addMusicToGroup(Scary, Gdx.audio.newMusic(Gdx.files.internal("music/Scary/Electro Zombies.mp3")));
        jukebox.addMusicToGroup(Scary, Gdx.audio.newMusic(Gdx.files.internal("music/Scary/In Doubt.mp3")));
        jukebox.addMusicToGroup(Scary, Gdx.audio.newMusic(Gdx.files.internal("music/Scary/Outcast.mp3")));
        jukebox.addMusicToGroup(Scary, Gdx.audio.newMusic(Gdx.files.internal("music/Scary/Prairie Dogs.mp3")));
