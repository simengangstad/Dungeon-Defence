...
public class Player extends Entity implements InputProcessor {
    ...
    public static Sound[] Walking = new Sound[] {Gdx.audio.newSound(Gdx.files.internal("sfx/walking1.wav")), Gdx.audio.newSound(Gdx.files.internal("sfx/walking2.wav"))};

    private int walkStep = 0;

    private float timeToNextStep = 0.0f;

    public static final Sound Rocks = Gdx.audio.newSound(Gdx.files.internal("sfx/rocks.wav"));
