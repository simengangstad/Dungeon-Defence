...
import io.github.simengangstad.dungeondefence.scene.ImpactCallback;
import io.github.simengangstad.dungeondefence.scene.Projectile;
...
public class Caterpillar extends Enemy {
    ...
    public static final Sound Hiss = Gdx.audio.newSound(Gdx.files.internal("sfx/hiss.wav")), Spitting = Gdx.audio.newSound(Gdx.files.internal("sfx/spitting.wav"));
        ...
        if (currentAnimation != AttackAnimation) {
            ...
            requestAnimation(AttackAnimation, new Callback() {
                ...
                public void callback() {
                    ...
                    TextureRegion[] array = new TextureRegion[projectingAnimation.getKeyFrames().length];
                    for (int  i = 0; i < array.length; i++) {
                        array[i] = (TextureRegion) projectingAnimation.getKeyFrames()[i];
                    }
                    projectile.computeTiledCollisionMaps(array, 16, 16);
