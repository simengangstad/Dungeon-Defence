...
import io.github.simengangstad.dungeondefence.scene.items.RotatableWeapon;
...
public class Orc extends Enemy {
    ...
    public static Sound[] roar = new Sound[] { Gdx.audio.newSound(Gdx.files.internal("sfx/orc1.wav")), Gdx.audio.newSound(Gdx.files.internal("sfx/orc2.wav"))};
